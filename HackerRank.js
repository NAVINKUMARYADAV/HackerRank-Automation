...
.then(function(){
    ...
    let questionPromise=questionsSolver(questionsArr[0],code.answers[0]);
    console.log(questionsArr);
    console.log(code.answers.length);
    for(let i=1;i< questionsArr.length;i++){
        questionPromise=questionPromise.then(function(){
          let nextQuestionPromise=questionsSolver(questionsArr[i],code.answers[i]);
...
function questionsSolver(questions,answers){
    return new Promise(function(resolve,reject){
        ...
        .then(function(){
            ...
            console.log("questions sumitted successfull");
            resolve();
